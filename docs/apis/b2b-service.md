...
- **대부분 `1.0.0` 단일 버전.** 복수 버전을 제공하는 엔드포인트는 아래 11개가 전부다.

| Method | Path | 제공 버전 | 최신 | 버전 간 차이 |
|---|---|---|---|---|
| POST | [`/users`](#7-post-apiv2b2busers) | `1.0.0` `1.0.1` | `1.0.1` | country 표기 — `1.0.0` alpha-2 / `1.0.1` alpha-3 |
| GET | [`/users/{b2bUserId}`](#8-get-apiv2b2busersb2buserid) | `1.0.0` `1.0.1` | `1.0.1` | country 표기 — `1.0.0` alpha-2 / `1.0.1` alpha-3 |
| PATCH | [`/users/{b2bUserId}`](#9-patch-apiv2b2busersb2buserid) | `1.0.0` `1.0.1` | `1.0.1` | country 표기 — `1.0.0` alpha-2 / `1.0.1` alpha-3 |
| POST | [`/organizations`](#13-post-apiv2b2borganizations) | `1.0.0` `1.0.1` `1.0.2` | `1.0.2` | `1.0.1`+ — country·BRN **필수**, 응답 stats 추가 · `1.0.2` — country alpha-3 |
| GET | [`/organizations/{id}`](#15-get-apiv2b2borganizationsid) | `1.0.0` `1.0.1` `1.0.2` | `1.0.2` | `1.0.1`+ — BRN·stats 노출 · `1.0.2` — country alpha-3 |
| POST | [`/organizations/{organizationId}/devices`](#29-post-apiv2b2borganizationsorganizationiddevices) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
| GET | [`/organizations/{organizationId}/devices`](#30-get-apiv2b2borganizationsorganizationiddevices) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
| GET | [`/organizations/{organizationId}/devices/{deviceId}`](#32-get-apiv2b2borganizationsorganizationiddevicesdeviceid) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
| PATCH | [`/organizations/{organizationId}/devices/{deviceId}`](#33-patch-apiv2b2borganizationsorganizationiddevicesdeviceid) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
| DELETE | [`/organizations/{organizationId}/devices/{deviceId}`](#34-delete-apiv2b2borganizationsorganizationiddevicesdeviceid) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
| POST | [`/organizations/{organizationId}/devices/{deviceId}/deactivate`](#35-post-apiv2b2borganizationsorganizationiddevicesdeviceiddeactivate) | `1.0.0` `1.0.1` | `1.0.1` | `1.0.1` — 응답에 `deviceType` · `deviceNumber` 추가 |
...
<details>
<summary><b>auth</b> (5개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/auth/login`](#1-post-apiv2b2bauthlogin) | 1.0.0 | 공개 | 이메일·비밀번호 로그인 |
| POST | [`/auth/token`](#2-post-apiv2b2bauthtoken) | 1.0.0 | 공개 | refresh token 회전 → 새 access + refresh 토큰 쌍 재발급 |
| POST | [`/auth/logout`](#3-post-apiv2b2bauthlogout) | 1.0.0 | 공개 | 로그아웃 |
| POST | [`/auth/oauth2/google`](#4-post-apiv2b2bauthoauth2google) | 1.0.0 | 공개 | 모바일 클라이언트가 네이티브 SDK 로 받은 Google `idToken` 을 검증하고 Care… |
| POST | [`/auth/oauth2/apple`](#5-post-apiv2b2bauthoauth2apple) | 1.0.0 | 공개 | 모바일 클라이언트가 네이티브 SDK 로 받은 Apple `idToken` 을 검증하고 CareN… |

</details>

<details>
<summary><b>users</b> (5개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/users`](#7-post-apiv2b2busers) | **1.0.0, 1.0.1** | 공개 | 관리자(b2b_user) 회원가입 |
| GET | [`/users/{b2bUserId}`](#8-get-apiv2b2busersb2buserid) | **1.0.0, 1.0.1** | Bearer | 본인 프로필 상세 + 소속 organization 목록(멀티-org, license 요약 포함)… |
| PATCH | [`/users/{b2bUserId}`](#9-patch-apiv2b2busersb2buserid) | **1.0.0, 1.0.1** | Bearer | 본인 프로필 부분 수정 |
| DELETE | [`/users/{b2bUserId}`](#10-delete-apiv2b2busersb2buserid) | 1.0.0 | Bearer | 본인 계정 소프트 탈퇴 — `DELETION_PENDING` 으로 전환하고 전 세션을 revok… |
| POST | [`/users/{b2bUserId}/password`](#11-post-apiv2b2busersb2buseridpassword) | 1.0.0 | Bearer | 기존 비밀번호 확인 후 변경 |

</details>

<details>
<summary><b>organizations</b> (5개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/organizations`](#13-post-apiv2b2borganizations) | **1.0.0, 1.0.1, 1.0.2** | Bearer | 시설(organization) 등록 — 인증된 b2b_user 가 owner 로 자동 지정된다 |
| GET | [`/organizations/search`](#14-get-apiv2b2borganizationssearch) | 1.0.0 | 공개 | `searchable=true` + `status=ACTIVE` 시설 검색 (Carenco 사용… |
| GET | [`/organizations/{id}`](#15-get-apiv2b2borganizationsid) | **1.0.0, 1.0.1, 1.0.2** | 공개 | 단건 시설 조회 |
| PATCH | [`/organizations/{id}`](#16-patch-apiv2b2borganizationsid) | 1.0.0 | Bearer | 부분 수정 — 모든 필드가 `JsonNullable<T>` (absent = 변경 없음, `nu… |
| DELETE | [`/organizations/{id}`](#17-delete-apiv2b2borganizationsid) | 1.0.0 | Bearer | 시설 소프트 삭제 — owner 만 |

</details>

<details>
<summary><b>organizations — 멤버/가입</b> (6개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/organizations/{organizationId}/staff`](#18-post-apiv2b2borganizationsorganizationidstaff) | 1.0.0 | Bearer | OWNER/ADMIN 이 b2b_user 를 `ADMIN` 또는 `TRAINER` 로 직접 등록… |
| GET | [`/organizations/{organizationId}/members`](#19-get-apiv2b2borganizationsorganizationidmembers) | 1.0.0 | Bearer | 회원 목록 조회·검색 (트레이너 대시보드) |
| POST | [`/organizations/{organizationId}/join-requests`](#20-post-apiv2b2borganizationsorganizationidjoin-requests) | 1.0.0 | 공개 | Carenco 사용자가 검색 결과 시설에 가입 신청 (pull 모델) |
| GET | [`/organizations/{organizationId}/members/{memberId}/measurements`](#38-get-apiv2b2borganizationsorganizationidmembersmemberidmeasurements) | 1.0.0 | Bearer | 조직 멤버의 측정 record 페이지 |
| GET | [`/organizations/{organizationId}/members/{memberId}/measurements/summary`](#39-get-apiv2b2borganizationsorganizationidmembersmemberidmeasurementssummary) | 1.0.0 | Bearer | 멤버 측정 요약 (누적 / 당월 / 마지막 측정 스냅샷) |
| GET | [`/organizations/{organizationId}/members/{memberId}/measurements/{recordId}`](#40-get-apiv2b2borganizationsorganizationidmembersmemberidmeasurementsrecordid) | 1.0.0 | Bearer | 멤버 측정 record 단건 (전체 footprint / vision 상세) |

</details>

<details>
<summary><b>organizations — devices</b> (7개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/organizations/{organizationId}/devices`](#29-post-apiv2b2borganizationsorganizationiddevices) | **1.0.0, 1.0.1** | Bearer | 시리얼로 device 를 organization 에 등록 (claim) |
| GET | [`/organizations/{organizationId}/devices`](#30-get-apiv2b2borganizationsorganizationiddevices) | **1.0.0, 1.0.1** | Bearer | organization 의 device 목록 |
| GET | [`/organizations/{organizationId}/devices/preview`](#31-get-apiv2b2borganizationsorganizationiddevicespreview) | 1.0.0 | Bearer | 시리얼 입력 후 등록 전 미리보기 (풀 조회만, claim 안 함) |
| GET | [`/organizations/{organizationId}/devices/{deviceId}`](#32-get-apiv2b2borganizationsorganizationiddevicesdeviceid) | **1.0.0, 1.0.1** | Bearer | device 단건 상세 |
| PATCH | [`/organizations/{organizationId}/devices/{deviceId}`](#33-patch-apiv2b2borganizationsorganizationiddevicesdeviceid) | **1.0.0, 1.0.1** | Bearer | device alias 부분 수정 |
| DELETE | [`/organizations/{organizationId}/devices/{deviceId}`](#34-delete-apiv2b2borganizationsorganizationiddevicesdeviceid) | **1.0.0, 1.0.1** | Bearer | 영구 삭제 — REVOKED + 풀 unclaim (일시 정지 deactivate 와 다름) |
| POST | [`/organizations/{organizationId}/devices/{deviceId}/deactivate`](#35-post-apiv2b2borganizationsorganizationiddevicesdeviceiddeactivate) | **1.0.0, 1.0.1** | Bearer | device 일시 정지 (측정 불가) |

</details>

<details>
<summary><b>memberships / b2c</b> (6개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| GET | [`/availability`](#6-get-apiv2b2bavailability) | 1.0.0 | 공개 | b2b 가입 전 이메일 등 필드 값의 사용 가능 여부(중복 아님)를 확인한다 |
| GET | [`/b2c-members/{carencoUserId}/organizations`](#12-get-apiv2b2bb2c-memberscarencouseridorganizations) | 1.0.0 | 공개 | B2C(carenco) 회원이 가입한 b2b 시설 목록 조회 |
| POST | [`/memberships/{membershipId}/approve`](#21-post-apiv2b2bmembershipsmembershipidapprove) | 1.0.0 | Bearer | PENDING 멤버십을 OWNER/ADMIN 이 승인 → 좌석 점유(license/seat gu… |
| POST | [`/memberships/{membershipId}/reject`](#22-post-apiv2b2bmembershipsmembershipidreject) | 1.0.0 | Bearer | PENDING 멤버십을 OWNER/ADMIN 이 거절 → `LEFT` (history 보존, a… |
| POST | [`/memberships/{membershipId}/suspend`](#23-post-apiv2b2bmembershipsmembershipidsuspend) | 1.0.0 | Bearer | ACTIVE 멤버십을 OWNER/ADMIN 이 일시 정지 → `SUSPENDED` (좌석 점유 … |
| POST | [`/memberships/{membershipId}/leave`](#24-post-apiv2b2bmembershipsmembershipidleave) | 1.0.0 | 공개 | 멤버 본인 탈퇴 → 좌석 해제 후 `LEFT` |

</details>

<details>
<summary><b>invite-codes</b> (4개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| GET | [`/organizations/{organizationId}/invite-codes`](#25-get-apiv2b2borganizationsorganizationidinvite-codes) | 1.0.0 | Bearer | organization 의 `ACTIVE` 초대 코드 목록 |
| POST | [`/organizations/{organizationId}/invite-codes`](#26-post-apiv2b2borganizationsorganizationidinvite-codes) | 1.0.0 | Bearer | 초대 코드 발급 — OWNER/ADMIN |
| POST | [`/invite-codes/redeem`](#27-post-apiv2b2binvite-codesredeem) | 1.0.0 | 공개 | Carenco 사용자가 코드를 입력하여 가입 |
| POST | [`/invite-codes/{inviteCodeId}/revoke`](#28-post-apiv2b2binvite-codesinvitecodeidrevoke) | 1.0.0 | Bearer | 초대 코드 폐기 — OWNER/ADMIN |

</details>

<details>
<summary><b>billing</b> (12개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/billing/checkout-init`](#46-post-apiv2b2bbillingcheckout-init) | 1.0.0 | Bearer | 신규/갱신 체크아웃 시작 |
| POST | [`/billing/plan-change`](#47-post-apiv2b2bbillingplan-change) | 1.0.0 | Bearer | active 구독의 plan 교체 (업/다운그레이드) |
| GET | [`/billing/organizations/{organizationId}/transactions`](#48-get-apiv2b2bbillingorganizationsorganizationidtransactions) | 1.0.0 | Bearer | organization 구독의 결제 내역 |
| GET | [`/billing/organizations/{organizationId}/subscription`](#49-get-apiv2b2bbillingorganizationsorganizationidsubscription) | 1.0.0 | Bearer | organization 현재 구독 상세 (scheduledChange 포함) |
| POST | [`/billing/organizations/{organizationId}/subscription/cancel`](#50-post-apiv2b2bbillingorganizationsorganizationidsubscriptioncancel) | 1.0.0 | Bearer | 구독 취소 (cycle-end) |
| POST | [`/billing/organizations/{organizationId}/subscription/pause`](#51-post-apiv2b2bbillingorganizationsorganizationidsubscriptionpause) | 1.0.0 | Bearer | 구독 일시정지 |
| POST | [`/billing/organizations/{organizationId}/subscription/resume`](#52-post-apiv2b2bbillingorganizationsorganizationidsubscriptionresume) | 1.0.0 | Bearer | 일시정지/취소 예약 구독 재개 |
| POST | [`/billing/organizations/{organizationId}/refunds`](#53-post-apiv2b2bbillingorganizationsorganizationidrefunds) | 1.0.0 | Bearer | 거래 환불 생성 (전체 또는 부분) |
| GET | [`/billing/organizations/{organizationId}/refunds`](#54-get-apiv2b2bbillingorganizationsorganizationidrefunds) | 1.0.0 | Bearer | 거래의 환불 목록 |
| GET | [`/billing/organizations/{organizationId}/refunds/{refundId}`](#55-get-apiv2b2bbillingorganizationsorganizationidrefundsrefundid) | 1.0.0 | Bearer | 환불 단건 조회 |
| POST | [`/billing/organizations/{organizationId}/portal-session`](#56-post-apiv2b2bbillingorganizationsorganizationidportal-session) | 1.0.0 | Bearer | Paddle 호스팅 고객 포털 세션 생성 (overview / 송장 / 결제수단 deep link) |
| GET | [`/billing/plans`](#57-get-apiv2b2bbillingplans) | 1.0.0 | Bearer | B2B plan 카탈로그 (planCode × variants) |

</details>

<details>
<summary><b>feedbacks</b> (5개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/feedbacks/memberships/{membershipId}`](#41-post-apiv2b2bfeedbacksmembershipsmembershipid) | 1.0.0 | Bearer | 멤버(membership)에 피드백 작성 |
| GET | [`/feedbacks/memberships/{membershipId}`](#42-get-apiv2b2bfeedbacksmembershipsmembershipid) | 1.0.0 | Bearer | membership 의 피드백 목록 (soft-delete 제외) |
| GET | [`/feedbacks/measurements/{recordId}`](#43-get-apiv2b2bfeedbacksmeasurementsrecordid) | 1.0.0 | Bearer | 특정 측정 record 에 연결된 피드백 목록 (soft-delete 제외) |
| PATCH | [`/feedbacks/{feedbackId}`](#44-patch-apiv2b2bfeedbacksfeedbackid) | 1.0.0 | Bearer | 피드백 본문 수정 |
| DELETE | [`/feedbacks/{feedbackId}`](#45-delete-apiv2b2bfeedbacksfeedbackid) | 1.0.0 | Bearer | 피드백 soft-delete (`deletedAt` 세팅) |

</details>

<details>
<summary><b>license-summary</b> (2개)</summary>

| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| GET | [`/license-summary`](#36-get-apiv2b2blicense-summary) | 1.0.0 | Bearer | 로그인 사용자가 소유(OWNER) 또는 ACTIVE B2B 멤버인 모든 organization … |
| GET | [`/license-summary/{organizationId}`](#37-get-apiv2b2blicense-summaryorganizationid) | 1.0.0 | Bearer | 특정 organization 의 license 단건 |
...
## 4. `POST` /api/v2/b2b/auth/oauth2/google
...
## 5. `POST` /api/v2/b2b/auth/oauth2/apple
...
## 8. `GET` /api/v2/b2b/users/{b2bUserId}
...
## 9. `PATCH` /api/v2/b2b/users/{b2bUserId}
...
## 11. `POST` /api/v2/b2b/users/{b2bUserId}/password
...
## 12. `GET` /api/v2/b2b/b2c-members/{carencoUserId}/organizations
...
## 13. `POST` /api/v2/b2b/organizations
...
## 14. `GET` /api/v2/b2b/organizations/search
...
## 15. `GET` /api/v2/b2b/organizations/{id}
...
POST §1 의 Response 필드 대조표와 동일. `stats` 세부:
...
## 16. `PATCH` /api/v2/b2b/organizations/{id}
...
## 17. `DELETE` /api/v2/b2b/organizations/{id}
...
## 18. `POST` /api/v2/b2b/organizations/{organizationId}/staff
...
## 19. `GET` /api/v2/b2b/organizations/{organizationId}/members
...
## 20. `POST` /api/v2/b2b/organizations/{organizationId}/join-requests
...
## 21. `POST` /api/v2/b2b/memberships/{membershipId}/approve
...
## 22. `POST` /api/v2/b2b/memberships/{membershipId}/reject
...
## 23. `POST` /api/v2/b2b/memberships/{membershipId}/suspend
...
## 24. `POST` /api/v2/b2b/memberships/{membershipId}/leave
...
## 25. `GET` /api/v2/b2b/organizations/{organizationId}/invite-codes
...
## 26. `POST` /api/v2/b2b/organizations/{organizationId}/invite-codes
...
## 27. `POST` /api/v2/b2b/invite-codes/redeem
...
## 28. `POST` /api/v2/b2b/invite-codes/{inviteCodeId}/revoke
...
## 29. `POST` /api/v2/b2b/organizations/{organizationId}/devices
...
## 30. `GET` /api/v2/b2b/organizations/{organizationId}/devices
...
## 31. `GET` /api/v2/b2b/organizations/{organizationId}/devices/preview
...
## 32. `GET` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}
...
## 33. `PATCH` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}
...
## 34. `DELETE` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}
...
## 35. `POST` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}/deactivate
...
## 36. `GET` /api/v2/b2b/license-summary
...
## 37. `GET` /api/v2/b2b/license-summary/{organizationId}
...
## 38. `GET` /api/v2/b2b/organizations/{organizationId}/members/{memberId}/measurements
...
## 39. `GET` /api/v2/b2b/organizations/{organizationId}/members/{memberId}/measurements/summary
...
## 40. `GET` /api/v2/b2b/organizations/{organizationId}/members/{memberId}/measurements/{recordId}
...
## 41. `POST` /api/v2/b2b/feedbacks/memberships/{membershipId}
...
## 42. `GET` /api/v2/b2b/feedbacks/memberships/{membershipId}
...
## 43. `GET` /api/v2/b2b/feedbacks/measurements/{recordId}
...
## 44. `PATCH` /api/v2/b2b/feedbacks/{feedbackId}
...
## 45. `DELETE` /api/v2/b2b/feedbacks/{feedbackId}
...
## 46. `POST` /api/v2/b2b/billing/checkout-init
...
## 47. `POST` /api/v2/b2b/billing/plan-change
...
## 48. `GET` /api/v2/b2b/billing/organizations/{organizationId}/transactions
...
## 49. `GET` /api/v2/b2b/billing/organizations/{organizationId}/subscription
...
## 50. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/cancel
...
## 51. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/pause
...
## 52. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/resume
...
## 53. `POST` /api/v2/b2b/billing/organizations/{organizationId}/refunds
...
## 54. `GET` /api/v2/b2b/billing/organizations/{organizationId}/refunds
...
## 55. `GET` /api/v2/b2b/billing/organizations/{organizationId}/refunds/{refundId}
...
## 56. `POST` /api/v2/b2b/billing/organizations/{organizationId}/portal-session
