...
| devices (deviceType·deviceNumber) | [`목록`](#23-get-apiv2b2borganizationsorganizationiddevices) · [`등록`](#22-post-apiv2b2borganizationsorganizationiddevices) · [`단건`](#25-get-apiv2b2borganizationsorganizationiddevicesdeviceid) · [`수정`](#26-patch-apiv2b2borganizationsorganizationiddevicesdeviceid) · [`삭제`](#27-delete-apiv2b2borganizationsorganizationiddevicesdeviceid) · [`deactivate`](#28-post-apiv2b2borganizationsorganizationiddevicesdeviceiddeactivate) | `1.0.1` |
...
| DELETE | [`/users/{b2bUserId}`](#9-delete-apiv2b2busersb2buserid) | 1.0.0 | Bearer | 본인 계정 소프트 탈퇴 — `DELETION_PENDING` 으로 전환하고 전 세션을 revok… |
| POST | [`/users/{b2bUserId}/password`](#10-post-apiv2b2busersb2buseridpassword) | 1.0.0 | Bearer | 기존 비밀번호 확인 후 변경 |
...
| GET | [`/organizations/{organizationId}/members`](#17-get-apiv2b2borganizationsorganizationidmembers) | 1.0.0 | Bearer | 회원 목록 조회·검색 (트레이너 대시보드) |
| POST | [`/organizations/{organizationId}/join-requests`](#18-post-apiv2b2borganizationsorganizationidjoin-requests) | 1.0.0 | 공개 | Carenco 사용자가 검색 결과 시설에 가입 신청 (pull 모델) |
...
| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/organizations/{organizationId}/devices`](#22-post-apiv2b2borganizationsorganizationiddevices) | **1.0.0, 1.0.1** | Bearer | 시리얼로 device 를 organization 에 등록 (claim) |
| GET | [`/organizations/{organizationId}/devices`](#23-get-apiv2b2borganizationsorganizationiddevices) | **1.0.0, 1.0.1** | Bearer | organization 의 device 목록 |
| GET | [`/organizations/{organizationId}/devices/preview`](#24-get-apiv2b2borganizationsorganizationiddevicespreview) | 1.0.0 | Bearer | 시리얼 입력 후 등록 전 미리보기 (풀 조회만, claim 안 함) |
...
| DELETE | [`/organizations/{organizationId}/devices/{deviceId}`](#27-delete-apiv2b2borganizationsorganizationiddevicesdeviceid) | **1.0.0, 1.0.1** | Bearer | 영구 삭제 — REVOKED + 풀 unclaim (일시 정지 deactivate 와 다름) |
| POST | [`/organizations/{organizationId}/devices/{deviceId}/deactivate`](#28-post-apiv2b2borganizationsorganizationiddevicesdeviceiddeactivate) | **1.0.0, 1.0.1** | Bearer | device 일시 정지 (측정 불가) |
...
| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| GET | [`/organizations/{organizationId}/invite-codes`](#35-get-apiv2b2borganizationsorganizationidinvite-codes) | 1.0.0 | Bearer | organization 의 `ACTIVE` 초대 코드 목록 |
| POST | [`/organizations/{organizationId}/invite-codes`](#36-post-apiv2b2borganizationsorganizationidinvite-codes) | 1.0.0 | Bearer | 초대 코드 발급 — OWNER/ADMIN |
...
| Method | Path (`/api/v2/b2b` 이하) | 버전 | 인증 | 설명 |
|---|---|---|---|---|
| POST | [`/billing/checkout-init`](#39-post-apiv2b2bbillingcheckout-init) | 1.0.0 | Bearer | 신규/갱신 체크아웃 시작 |
| POST | [`/billing/plan-change`](#40-post-apiv2b2bbillingplan-change) | 1.0.0 | Bearer | active 구독의 plan 교체 (업/다운그레이드) |
| GET | [`/billing/organizations/{organizationId}/transactions`](#41-get-apiv2b2bbillingorganizationsorganizationidtransactions) | 1.0.0 | Bearer | organization 구독의 결제 내역 |
| GET | [`/billing/organizations/{organizationId}/subscription`](#42-get-apiv2b2bbillingorganizationsorganizationidsubscription) | 1.0.0 | Bearer | organization 현재 구독 상세 (scheduledChange 포함) |
| POST | [`/billing/organizations/{organizationId}/subscription/cancel`](#43-post-apiv2b2bbillingorganizationsorganizationidsubscriptioncancel) | 1.0.0 | Bearer | 구독 취소 (cycle-end) |
| POST | [`/billing/organizations/{organizationId}/subscription/pause`](#44-post-apiv2b2bbillingorganizationsorganizationidsubscriptionpause) | 1.0.0 | Bearer | 구독 일시정지 |
| POST | [`/billing/organizations/{organizationId}/subscription/resume`](#45-post-apiv2b2bbillingorganizationsorganizationidsubscriptionresume) | 1.0.0 | Bearer | 일시정지/취소 예약 구독 재개 |
| POST | [`/billing/organizations/{organizationId}/refunds`](#46-post-apiv2b2bbillingorganizationsorganizationidrefunds) | 1.0.0 | Bearer | 거래 환불 생성 (전체 또는 부분) |
| GET | [`/billing/organizations/{organizationId}/refunds`](#47-get-apiv2b2bbillingorganizationsorganizationidrefunds) | 1.0.0 | Bearer | 거래의 환불 목록 |
| GET | [`/billing/organizations/{organizationId}/refunds/{refundId}`](#48-get-apiv2b2bbillingorganizationsorganizationidrefundsrefundid) | 1.0.0 | Bearer | 환불 단건 조회 |
| POST | [`/billing/organizations/{organizationId}/portal-session`](#49-post-apiv2b2bbillingorganizationsorganizationidportal-session) | 1.0.0 | Bearer | Paddle 호스팅 고객 포털 세션 생성 (overview / 송장 / 결제수단 deep link) |
| GET | [`/billing/plans`](#50-get-apiv2b2bbillingplans) | 1.0.0 | Bearer | B2B plan 카탈로그 (planCode × variants) |
...
## 9. `DELETE` /api/v2/b2b/users/{b2bUserId}
...
## 10. `POST` /api/v2/b2b/users/{b2bUserId}/password
...
## 17. `GET` /api/v2/b2b/organizations/{organizationId}/members
...
## 18. `POST` /api/v2/b2b/organizations/{organizationId}/join-requests
...
## 22. `POST` /api/v2/b2b/organizations/{organizationId}/devices
...
## 23. `GET` /api/v2/b2b/organizations/{organizationId}/devices
...
## 24. `GET` /api/v2/b2b/organizations/{organizationId}/devices/preview
...
## 27. `DELETE` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}
...
## 28. `POST` /api/v2/b2b/organizations/{organizationId}/devices/{deviceId}/deactivate
...
## 35. `GET` /api/v2/b2b/organizations/{organizationId}/invite-codes
...
## 36. `POST` /api/v2/b2b/organizations/{organizationId}/invite-codes
...
## 39. `POST` /api/v2/b2b/billing/checkout-init
...
## 40. `POST` /api/v2/b2b/billing/plan-change
...
## 41. `GET` /api/v2/b2b/billing/organizations/{organizationId}/transactions
...
## 42. `GET` /api/v2/b2b/billing/organizations/{organizationId}/subscription
...
## 43. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/cancel
...
## 44. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/pause
...
## 45. `POST` /api/v2/b2b/billing/organizations/{organizationId}/subscription/resume
...
## 46. `POST` /api/v2/b2b/billing/organizations/{organizationId}/refunds
...
## 47. `GET` /api/v2/b2b/billing/organizations/{organizationId}/refunds
...
## 48. `GET` /api/v2/b2b/billing/organizations/{organizationId}/refunds/{refundId}
...
## 49. `POST` /api/v2/b2b/billing/organizations/{organizationId}/portal-session
...
## 50. `GET` /api/v2/b2b/billing/plans
